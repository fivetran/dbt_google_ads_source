# [DEPRECATED] Google Ads Source dbt Package

> _This package has been archived and is no longer maintained. Use [`dbt_google_ads`](https://github.com/fivetran/dbt_google_ads) instead, which now contains all models previously found here._
