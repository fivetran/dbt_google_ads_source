...
Please note that unless you have a single schema in the `google_ads_schema` variable, the freshness tests generated by this plugin will fail. Please refer to the [DBT overrides](https://docs.getdbt.com/reference/resource-properties/overrides) for other fine-tuning options.
