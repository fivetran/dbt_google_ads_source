...
final as (
    ...
    select
        ...
        {{ google_ads_fill_pass_through_columns(pass_through_fields=var('google_ads__keyword_stats_passthrough_metrics'), except=['conversions', "conversion_value", "view_through_conversions"]) }}
