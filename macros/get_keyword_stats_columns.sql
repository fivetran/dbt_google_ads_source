...
{{ google_ads_add_pass_through_columns(base_columns=columns, pass_through_fields=var('google_ads__keyword_stats_passthrough_metrics'), except_fields=['conversions', "conversion_value", "view_through_conversions"]) }}
